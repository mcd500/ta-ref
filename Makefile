...
BUILD_DIR=build
TEST_DIR=test_hello
OPTEE_OUTBR_DIRECTORY=/home/user/optee/out-br
OPTEE_TEST_HELLO_DIR=${OPTEE_OUTBR_DIRECTORY}/images/rootfs/root/test_hello
OPTEE_TEST_GP_DIR=${OPTEE_OUTBR_DIRECTORY}/images/rootfs/root/test_gp
...
install_optee_qemu:
	...
	mkdir -p ${OPTEE_OUTBR_DIRECTORY}/images/rootfs/
	cd ${OPTEE_OUTBR_DIRECTORY}/images/rootfs; \
	sudo gzip -dc ../rootfs.cpio.gz | sudo cpio -i
	export OPTEE_TEST_HELLO_DIR=${OPTEE_OUTBR_DIRECTORY}/images/rootfs/root/test_hello
	...
	export OPTEE_TEST_GP_DIR=${OPTEE_OUTBR_DIRECTORY}/images/rootfs/root/test_gp
