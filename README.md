...
|keystone(HIFIVE)|[trasioteam/ta_ref_devel:keystone_hifive](https://192.168.100.100/rinkai/dockerfiles/-/blob/master/ta-ref/keystone_hifive/Dockerfile)|v0.3|see keystone(TRVSIM)|
|keystone(VC707)|[trasioteam/ta_ref_devel:keystone_qemu](https://192.168.100.100/rinkai/dockerfiles/-/blob/master/ta-ref/keystone_qemu/Dockerfile)|v0.3|see keystone(qemu: SIM)|
|intel_sgx(SIM/NUC)|[trasioteam/ta_ref_devel:sgx](https://192.168.100.100/rinkai/dockerfiles/-/blob/master/ta-ref/sgx/Dockerfile)|2.8|[trasioteam/intel_sgx:2.8](https://192.168.100.100/rinkai/dockerfiles/-/blob/master/intel-sgx/devel/Dockerfile) <- ubuntu:20.04|
